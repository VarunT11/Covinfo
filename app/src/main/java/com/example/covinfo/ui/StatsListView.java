...
public class StatsListView {
    ...
    private BottomSortSheet bottomSortSheet;

    private TextView tvListConfirmedLabel, tvListDeceasedLabel;
    ...
    private void initializeView() {
        ...
        tvListConfirmedLabel = rootView.findViewById(R.id.tvStatsListConfirmed);
        TextView tvListRecoveredLabel = rootView.findViewById(R.id.tvStatsListRecovered);
        tvListDeceasedLabel = rootView.findViewById(R.id.tvStatsListDeceased);
        ...
        for (CaseType caseType : caseTypeList) {
            ...
            bottomSortSheet = new BottomSortSheet("BSS " + regionType.name(), caseTypeList, this::updateListSort);
            ...
            btnSort.setOnClickListener(v -> bottomSortSheet.show(activity.getSupportFragmentManager(), bottomSortSheet.getTAG()));
    ...
    private void updateListSearch(String name) {
        ...
        if(regionType == RegionType.COUNTRY){
            tvListConfirmedLabel.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_END);
            tvListDeceasedLabel.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_END);
            CountryItemAdapter itemAdapter = new CountryItemAdapter(displayList, countryAdapterInterface);
            rcvList.setAdapter(itemAdapter);

        } else {
            tvListConfirmedLabel.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
            tvListDeceasedLabel.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
