...
public class BottomSortSheet extends BottomSheetDialogFragment {
    ...
    private RadioGroup rgSort, rgOrder;
    private MaterialRadioButton rbName, rbConfirmed, rbRecovered, rbDeceased, rbActive, rbIncreasing, rbDecreasing;

    public BottomSortSheet(String tag, ArrayList<CaseType> CaseTypeList, SortSheetInterface sheetInterface) {
        TAG = tag;
